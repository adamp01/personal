...
The principal logic behind tracer bullets is to get some small, usable, testable chunk of the final system implemented quickly and visbily. A rather agile approach to development, one might think. It is generally agreed that complex systems evolve from simple systems that work, <a href="https://en.wikipedia.org/wiki/John_Gall_(author)#Gall's_law" target="\_blank" rel="noopener noreferrer" >Gall's law</a>, and as such when developing software we should be aiming to implement small working chunks that eventually evolve into a more complex feature or workflow.
